   ...
   .then(function(response){
       ...
       $('.hum').text("Humidity: "+response.main.humidity + "%");
        ...
        $.ajax({
            ...
            $('.day1-date').html("<h4>"+ dayjs(response.list[0].dt_txt).format( "MM/DD/YYYY")+"</h4>");
            ...
            $('.day2-date').html("<h4>"+ dayjs(response.list[8].dt_txt).format("MM/DD/YYYY")+"</h4>");
            ...
            $('.day3-date').html("<h4>"+ dayjs(response.list[16].dt_txt).format("MM/DD/YYYY")+"</h4>");
            ...
            $('.day4-date').html("<h4>"+ dayjs(response.list[24].dt_txt).format("MM/DD/YYYY")+"</h4>");
            ...
            $('.day5-date').html("<h4>"+ dayjs(response.list[31].dt_txt).format("MM/DD/YYYY")+"</h4>");
